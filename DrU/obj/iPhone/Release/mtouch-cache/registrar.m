...
@implementation GameViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "DrU.GameViewController, DrU, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_btn_back");
	}

	-(void) setBtn_back:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIBarButtonItem, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "DrU.GameViewController, DrU, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_btn_back");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIBarButtonItem, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "DrU.GameViewController, DrU, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "btn_back_Activated");
	}
...
void monotouch_create_classes () {
	...
	__monotouch_class_map [9].handle = [DrU_EstimoteViewController class];
	__monotouch_class_map [10].handle = objc_getClass ("CALayer");
	__monotouch_class_map [11].handle = objc_getClass ("CLRegion");
	__monotouch_class_map [12].handle = objc_getClass ("CLBeaconRegion");
	__monotouch_class_map [13].handle = objc_getClass ("CLLocation");
	__monotouch_class_map [14].handle = objc_getClass ("NSArray");
	__monotouch_class_map [15].handle = objc_getClass ("NSFileManager");
	__monotouch_class_map [16].handle = objc_getClass ("NSIndexPath");
	__monotouch_class_map [17].handle = objc_getClass ("MonoTouch_Foundation_InternalNSNotificationHandler");
	...
	__monotouch_class_map [22].handle = objc_getClass ("NSUUID");
	__monotouch_class_map [23].handle = objc_getClass ("CLHeading");
	__monotouch_class_map [24].handle = objc_getClass ("NSAutoreleasePool");
	__monotouch_class_map [25].handle = objc_getClass ("NSError");
	...
	__monotouch_class_map [29].handle = objc_getClass ("UIControl");
	__monotouch_class_map [30].handle = objc_getClass ("UIButton");
	__monotouch_class_map [31].handle = objc_getClass ("UIColor");
	__monotouch_class_map [32].handle = objc_getClass ("MonoTouch_UIKit_UIControlEventProxy");
	__monotouch_class_map [33].handle = objc_getClass ("UIDevice");
	__monotouch_class_map [34].handle = objc_getClass ("UIFont");
	__monotouch_class_map [35].handle = objc_getClass ("UIImage");
	...
	__monotouch_class_map [40].handle = objc_getClass ("UITextView");
	__monotouch_class_map [41].handle = objc_getClass ("UIWindow");
	__monotouch_class_map [42].handle = objc_getClass ("UITextPosition");
	__monotouch_class_map [43].handle = objc_getClass ("UITextRange");
	__monotouch_class_map [44].handle = objc_getClass ("UITextSelectionRect");
	__monotouch_class_map [45].handle = objc_getClass ("UILabel");
	__monotouch_class_map [46].handle = objc_getClass ("UIImageView");
	__monotouch_class_map [47].handle = objc_getClass ("UITraitCollection");
	__monotouch_class_map [48].handle = objc_getClass ("CLBeacon");
	__monotouch_class_map [49].handle = objc_getClass ("CLVisit");
	__monotouch_class_map [50].handle = objc_getClass ("NSException");
	__monotouch_class_map [51].handle = objc_getClass ("NSNull");
	__monotouch_class_map [52].handle = objc_getClass ("NSNotification");
	__monotouch_class_map [53].handle = objc_getClass ("MonoTouch_CoreLocation_CLLocationManager__CLLocationManagerDelegate");
	__monotouch_class_map [54].handle = objc_getClass ("CLLocationManager");
	__monotouch_class_map [55].handle = objc_getClass ("NSDictionary");
	__monotouch_class_map [56].handle = objc_getClass ("NSNotificationCenter");
	__monotouch_class_map [57].handle = objc_getClass ("__NSObject_Disposer");
	__monotouch_class_map [58].handle = objc_getClass ("MonoTouch_UIKit_UIBarButtonItem_Callback");
	__monotouch_class_map [59].handle = objc_getClass ("UIBarButtonItem");
	__monotouch_class_map [60].handle = objc_getClass ("MonoTouch_UIKit_UITextField__UITextFieldDelegate");
	__monotouch_class_map [61].handle = objc_getClass ("UITextField");
	monotouch_setup_classmap (__monotouch_class_map, 62);
}
