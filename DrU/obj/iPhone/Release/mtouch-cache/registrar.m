...
@interface DrUViewController : UIViewController {
	...
	@property (nonatomic, assign) id DrU_animation;
...
@implementation DrUViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "DrU.DrUViewController, DrU, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_DrU_animation");
	}

	-(void) setDrU_animation:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIImageView, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "DrU.DrUViewController, DrU, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_DrU_animation");
	}
...
void monotouch_create_classes () {
	...
	__monotouch_class_map [5].handle = objc_getClass ("CLRegion");
	__monotouch_class_map [6].handle = objc_getClass ("CLBeaconRegion");
	__monotouch_class_map [7].handle = objc_getClass ("CLLocation");
	__monotouch_class_map [8].handle = objc_getClass ("NSArray");
	__monotouch_class_map [9].handle = objc_getClass ("MonoTouch_Foundation_InternalNSNotificationHandler");
	__monotouch_class_map [10].handle = objc_getClass ("NSValue");
	__monotouch_class_map [11].handle = objc_getClass ("NSNumber");
	__monotouch_class_map [12].handle = objc_getClass ("NSString");
	__monotouch_class_map [13].handle = objc_getClass ("NSUUID");
	__monotouch_class_map [14].handle = objc_getClass ("CLHeading");
	...
	__monotouch_class_map [18].handle = objc_getClass ("UIBarItem");
	__monotouch_class_map [19].handle = objc_getClass ("UIBarButtonItem");
	...
	__monotouch_class_map [23].handle = objc_getClass ("UIDevice");
	__monotouch_class_map [24].handle = objc_getClass ("UITextField");
	__monotouch_class_map [25].handle = objc_getClass ("UIScrollView");
	__monotouch_class_map [26].handle = objc_getClass ("UITextView");
	__monotouch_class_map [27].handle = objc_getClass ("UIWindow");
	__monotouch_class_map [28].handle = objc_getClass ("UITextPosition");
	__monotouch_class_map [29].handle = objc_getClass ("UITextRange");
	__monotouch_class_map [30].handle = objc_getClass ("UITextSelectionRect");
	__monotouch_class_map [31].handle = objc_getClass ("UILabel");
	__monotouch_class_map [32].handle = objc_getClass ("UIImageView");
	__monotouch_class_map [33].handle = objc_getClass ("UITraitCollection");
	__monotouch_class_map [34].handle = objc_getClass ("CLBeacon");
	__monotouch_class_map [35].handle = objc_getClass ("CLVisit");
	__monotouch_class_map [36].handle = objc_getClass ("NSException");
	__monotouch_class_map [37].handle = objc_getClass ("NSNotification");
	__monotouch_class_map [38].handle = objc_getClass ("MonoTouch_CoreLocation_CLLocationManager__CLLocationManagerDelegate");
	__monotouch_class_map [39].handle = objc_getClass ("CLLocationManager");
	...
	monotouch_setup_classmap (__monotouch_class_map, 43);
}
